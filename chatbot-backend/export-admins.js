// Script to export all documents from the "admins" collection into a JSON file.
// Usage (from chatbot-backend folder):
//   node export-admins.js
...
async function main() {
  try {
    ...
    const filePath = path.join(exportDir, `admins-${timestamp}.json`);
